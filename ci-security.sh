...
Marketplace
Explore
A30003153/agl.cybersec.security-scans lines2.6k
 Unwatch 1
 Star0
 Fork
1
...
Settings
 master 
agl.cybersec.security-scans/ci-security.sh
Go to file
Sajid Pervez changes
Latest commit 4629d1d on 1 Apr History
 1 contributor
590 lines (535 sloc)  17.5 KB
RawBlame
#!/bin/bash
set -x
# Exit on error
